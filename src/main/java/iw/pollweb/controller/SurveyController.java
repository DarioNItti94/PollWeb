...
public class SurveyController extends BaseController {
    ...
    private void action_default(HttpServletRequest request, HttpServletResponse response) throws ServerException, IOException, TemplateManagerException{
        
    }

    private void action_open(HttpServletRequest request, HttpServletResponse response) throws ServerException, IOException, DataException, ServletException {
        ...
        if (survey.isClosed()) {
            throw new ServletException("Il songaggio è chiuso");
        } else if (survey != null) {
    ...
    private void action_dactivate(HttpServletRequest request, HttpServletResponse response) throws ServerException, DataException {
        int surveyID = SecurityLayer.checkNumeric(request.getParameter("id"));
        Survey survey = ((PollWebDataLayer) request.getAttribute("datalayer")).getSurveyDAO().getSurveyByID(surveyID);
        if(survey != null){
            survey.setActive(false);
